...
5) clear;echo 5;[ ! -e "logo_backup" ] && echo "The 'logo.img' file must be in the #LOGO folder in the internal memory to proceed." && menu;cat /sdcard/#LOGO/logo.img > /dev/block/by-name/up_param;echo "Updated logo!";;
